...
import { ErrorOverlay } from "@/components/ErrorOverlay"; // ✅ tu l'as bien dans components
...
export function ChatKitPanel({
  ...
  // appel à ton API create-session
  ...
  return (
    <div className="relative flex h-[85vh] w-full flex-col overflow-hidden rounded-2xl border border-slate-800 bg-slate-950 shadow-xl">
      <ChatKit
        ...
        className={
          blockingError || isInitializingSession
            ...
            : "block h-full w-full bg-slate-950 text-slate-50"
        }
      />
      <ErrorOverlay
        error={blockingError}
